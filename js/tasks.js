...
function fillDynamicTasksUndress() {
  ...
  Object.entries(clothes).forEach(([key, piece]) => {
    const task = {
      id: `undress_${key}`,
      titleKey: "TASK.UndressSelf.Title",
      instructionKey: "TASK.UndressSelf.Instruction.Public",
      instruction_args: { clothing: piece.name, p0: "" },
      conditions: {
        stage: [],
        intensity: [],
        extremity: [],
      ...
      participants: [
        {
          ...
          sex: [],
          secretInstructionKey: "TASK.UndressSelf.Instruction.Secret",
        },
      ],
    };
